...
import 'package:learningdart/services/crud/crud_const.dart';
...
class NotesService {
  ...
  Future<DatabaseNote> getNote({required int id}) async {
    ...
    if (results.isEmpty) throw CouldNotFindNoteException;
  ...
  Future<void> deleteNote({required DatabaseUser owner}) async {
    final db = _getDatabaseOrThrow();
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    if (owner != dbUser) throw CouldNotFindUserException;
  ...
  Database _getDatabaseOrThrow() {
    final db = _db;
    if (db == null) throw DatabaseIsClosedException();
    return db;
  }
  ...
  Future<void> open() async {
    if (_db != null) throw DatabaseOpenException;
    try {
      // opens database by finding path
